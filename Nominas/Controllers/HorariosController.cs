...
namespace Nominas.Controllers
{
    public class HorariosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Codigo_Horario,Hora_Inicio,Hora_Fin")] Horario horario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Codigo_Horario,Hora_Inicio,Hora_Fin")] Horario horario)
        {
            if (ModelState.IsValid)
            {
